					...
					<>
						...
						<div className={styles.section}>
							<div className={styles.sousSection}>
								<div className={styles.sectionContainer}>
									{dateCourante && (
									<div className={styles.sectionLigneDate}>
						...
						{/* Section information nutritionnelles*/}
						<div className={styles.section} >
							<div className={styles.titreSection}>Informations nutritionelles</div>
							<div className={styles.sousSection}>
								<div className={styles.sectionContainer}>

								{/* Poids  */}
								{ligne?.aliment.grammes && (
									<div className={styles.sectionLigne}>
										<div className={styles.sectionLignePrincipale}>
											<div className={styles.ligneTitre}>Poids</div>
											<div className={styles.ligneValeur}>{ligne?.aliment.grammes && (ligne.aliment.grammes * ligne.quantite).toFixed(2)} g</div>
										</div>
									</div>)}
								...
								<div className={styles.sectionLigne}>
									<div className={styles.sectionLignePrincipale}>
										<div className={styles.ligneTitre}>Energie</div>
										<div className={styles.ligneValeur}>{ligne?.aliment.calories && (ligne.aliment.calories * ligne.quantite).toFixed(2)}</div>
									</div>
								</div>
								...
								<div className={styles.sectionLigne}>
									<div className={styles.sectionLignePrincipale}>									
										...
										<div className={styles.ligneValeur}>{ligne?.aliment.matieresGrasses && (ligne.aliment.matieresGrasses * ligne.quantite).toFixed(2)} g</div>
									</div>
									<div className={styles.sectionSousLigne}>
										<div className={styles.ligneTitre}>Acides gras saturés</div>
										<div className={styles.ligneValeur}>{ligne?.aliment.acideGrasSature && (ligne.aliment.acideGrasSature * ligne.quantite).toFixed(2)} g</div>
									</div>
								</div>
								{/* Glucides et sucres et fibres */}
								<div className={styles.sectionLigne}>
									<div className={styles.sectionLignePrincipale}>
										<div className={styles.ligneTitre}>Glucides</div>
										<div className={styles.ligneValeur}>{ligne?.aliment.glucides && (ligne.aliment.glucides * ligne.quantite).toFixed(2)} g</div>
									</div>
									<div className={styles.sectionSousLigne}>
										<div className={styles.ligneTitre}>Sucres</div>
										<div className={styles.ligneValeur}>{ligne?.aliment.sucres && (ligne.aliment.sucres * ligne.quantite).toFixed(2)} g</div>
									</div>
									<div className={styles.sectionSousLigne}>
										<div className={styles.ligneTitre}>Fibres</div>
										<div className={styles.ligneValeur}>{ligne?.aliment.fibres && (ligne.aliment.fibres * ligne.quantite).toFixed(2)} g</div>
									</div>										
								</div>
								{/* Protéines */}
								<div className={styles.sectionLigne}>
									<div className={styles.sectionLignePrincipale}>
										...
										<div className={styles.ligneValeur}>{ligne?.aliment.proteines && (ligne.aliment.proteines * ligne.quantite).toFixed(2) } g</div>
									</div>
								</div>
								{/* Sel */}
								<div className={styles.sectionLigne}>
									<div className={styles.sectionLignePrincipale}>
										<div className={styles.ligneTitre}>Sel</div>
										<div className={styles.ligneValeur}>{ligne?.aliment.sel && (ligne.aliment.sel * ligne.quantite).toFixed(2)} g</div>
										</div>
										</div>
								</div>
							</div>
